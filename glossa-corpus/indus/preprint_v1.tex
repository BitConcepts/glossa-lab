...
\endlastfoot
Total seals & 1,670 \\
Fully decoded (all signs H+M, genuine) & 1,165 (69.8\%) \\
...
All \textbf{top blocking signs} (those preventing full decoding of
...
\subsubsection{4.3 The 18 Irresolvable
Signs}\label{the-18-irresolvable-signs}
...
Indus Valley Script to date: 161 genuine sign anchors at HIGH or MEDIUM confidence (90.96\% token coverage, 69.8\% fully covered by candidate H+M readings), and a
...
across all sites including maritime Lothal. The remaining 30.2\% of seals contain signs not yet covered by genuine H+M candidate readings, most likely personal-name syllables that are irresolvable without a bilingual text or larger corpus (ICIT access required for further progress).
