...
90.96\% token coverage across 7,002 corpus tokens, and full H+M-candidate coverage of
...
2 Munda substrate loanwords (kul, vī) among the 18 remaining unanchored
...
internal validation (59/59 consistency checks, Phases 1--170) is consistent with the Dravidian phonetic
...
\endlastfoot
Total seals & 1,670 \\
Fully covered by genuine H+M candidates & 1,165 (69.8\%) \\
...
(G-prefix ICIT coding) with an independent methodology, replicating the key structural result of our Phase-134 F1 test (z=10.3, p=0/2000) on an
...
(permutation $z=10.3$), a recurring three-slot inscription formula,
...
multiple converging tests but not yet externally validated. Speculative
...
(Dr.~Andreas Fuls, 5,318 texts; fuls@epigraphica.de) is the immediate
priority for testing whether the candidate model generalises. All phase
reports, scripts, and the anchor table are openly available.
...
and 30.2\% of seals not fully covered by H+M candidate readings (§3.6).
