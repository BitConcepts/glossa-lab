...
def add_manual_claims(doc_id: str) -> list[dict]:
    ...
    elif "indus_valley_script_deciphered_from_myth" in doc_id or "roif" in doc_id:
        manual = [
            {
                "claim_id": f"{doc_id}_manual_001",
                "source_document_id": doc_id,
                "claim_type": "sign_function_claim",
                "normalized_claim": "The Indus script encodes an economic ledger of trade guilds, tribute, and guild authority using Akkadian-influenced mnemonics.",
                "claim_status": "untested",
                "testability": "indirectly_testable",
                "falsification_condition": "If sign distributions are not correlated with trade/economic contexts at excavation sites.",
                "author": "Roif, Avishai",
                "confidence_in_source": 0.5,
                "extracted_at": ts,
            },
            {
                "claim_id": f"{doc_id}_manual_002",
                "source_document_id": doc_id,
                "claim_type": "sign_value_claim",
                "normalized_claim": "The fish sign encodes a coastal guild controller or maritime trader identity (Lothal-linked).",
                "signs_involved": ["fish sign family"],
                "proposed_value": "coastal guild / maritime trader",
                "claim_status": "partially_falsified",
                "testability": "directly_testable",
                "falsification_condition": "Fish sign should cluster at coastal/maritime sites (Lothal, Dholavira). Phase-4x CISI data shows fish NOT coastal-enriched.",
                "glossa_lab_evidence": "Phase-4x CISI analysis: fish sign not statistically enriched at coastal sites [PARTIALLY FALSIFIED]",
                "confidence_in_source": 0.45,
                "extracted_at": ts,
            },
            {
                "claim_id": f"{doc_id}_manual_003",
                "source_document_id": doc_id,
                "claim_type": "sign_function_claim",
                "normalized_claim": "The arrow sign (tīr) encodes border enforcement or guild authority.",
                "signs_involved": ["arrow sign"],
                "proposed_value": "tīr (enforcement at borders)",
                "claim_status": "untested",
                "testability": "directly_testable",
                "falsification_condition": "If arrow sign does not cluster at gateway/border sites.",
                "confidence_in_source": 0.5,
                "extracted_at": ts,
            },
            {
                "claim_id": f"{doc_id}_manual_004",
                "source_document_id": doc_id,
                "claim_type": "archaeological_context_claim",
                "normalized_claim": "The horned deity sign encodes fire-altar intermediary roles (Kalibangan fire-altars).",
                "signs_involved": ["horned deity sign"],
                "claim_status": "untested",
                "testability": "indirectly_testable",
                "required_data": "Site metadata with fire-altar classification (Kalibangan)",
                "falsification_condition": "Horned deity sign does not cluster at fire-altar sites.",
                "confidence_in_source": 0.5,
                "extracted_at": ts,
            },
        ]
    elif "without_kings_or_conquests" in doc_id or "hunt" in doc_id:
        manual = [
            {
                "claim_id": f"{doc_id}_manual_001",
                "source_document_id": doc_id,
                "claim_type": "inscription_structure_claim",
                "normalized_claim": "Indus inscriptions follow a tripartite grammar: prefix (identity/office/commodity) + medial (action/transaction/domain) + suffix (cycle/jurisdiction/logistics).",
                "claim_status": "partially_supported",
                "testability": "directly_testable",
                "falsification_condition": "If faunal signs are NOT enriched in initial position and celestial signs are NOT enriched in terminal position.",
                "glossa_lab_evidence": "Phase-43 Batch 5: formula_rate=35.5% vs null 0.6% (59x lift). 20 TERMINAL_STRONG + 40 INITIAL_STRONG signs. [STRUCTURALLY SUPPORTED]",
            ...
            },
            {
                ...
                "normalized_claim": "The Indus script functioned as a civic-ritual continuity system, not a phonetic script or royal propaganda — encoding ecological cycles, distributed governance, and civic identity.",
                "claim_status": "untested",
                "testability": "indirectly_testable",
                "falsification_condition": "If sign distributions correlate with palatial/royal contexts rather than civic/infrastructure contexts.",
                "confidence_in_source": 0.65,
                "extracted_at": ts,
            },
            {
                "claim_id": f"{doc_id}_manual_003",
                "source_document_id": doc_id,
                "claim_type": "sign_function_claim",
                "normalized_claim": "Faunal signs function as identity/guild/commodity prefixes (initial position).",
                "signs_involved": ["fish", "unicorn", "buffalo", "rhinoceros", "tiger", "elephant"],
                "claim_status": "partially_supported",
                "testability": "directly_testable",
                "falsification_condition": "Faunal signs not enriched in initial position above random baseline.",
                "glossa_lab_evidence": "Phase-43: 40 INITIAL_STRONG signs identified; faunal-initial enrichment not yet sign-classified [STRUCTURAL SUPPORT ONLY]",
                "confidence_in_source": 0.70,
                "extracted_at": ts,
            },
            {
                "claim_id": f"{doc_id}_manual_004",
                "source_document_id": doc_id,
                "claim_type": "sign_function_claim",
                "normalized_claim": "Celestial signs function as suffix/cycle markers (terminal position).",
                "signs_involved": ["star", "sun", "crescent", "seven-petaled"],
                "claim_status": "untested",
                "testability": "directly_testable",
                "falsification_condition": "Celestial signs not enriched in terminal position above random baseline.",
                "confidence_in_source": 0.70,
                "extracted_at": ts,
            },
            {
                "claim_id": f"{doc_id}_manual_005",
                "source_document_id": doc_id,
                "claim_type": "methodological_claim",
                "normalized_claim": "A 24-cluster Translation Atlas provides canonical sign forms, frequencies, and co-occurrence sets.",
                "claim_status": "untested",
                "testability": "indirectly_testable",
                "falsification_condition": "If the 24 clusters do not correspond to statistically distinct positional/co-occurrence profiles.",
                "confidence_in_source": 0.60,
                "extracted_at": ts,
            },
        ]
