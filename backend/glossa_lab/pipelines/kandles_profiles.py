...
The default Kandles system (US 2024/0248922 A1) uses a single
...
# The original Kandles mapping from US 2024/0248922 A1.
...
PROFILE_DEFAULT = KandlesProfile(
    name="default",
    description=(
        "Greek/English baseline (Merkur patent US 2024/0248922 A1). "
