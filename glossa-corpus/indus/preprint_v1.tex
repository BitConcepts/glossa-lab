...
(permutation null $z = 10.3$; permutation $p = 0/2000$),
...
\textit{Note: The MEDIUM count includes 4 PROVISIONAL\_MEDIUM signs (M330=\textit{can}, M165=\textit{cul}, M202=\textit{can}, M198=\textit{co}), included for coverage accounting but flagged for expert review before any HIGH-confidence promotion.}
...
All sign readings, confidence levels, DEDR citations, basis statements, analysis scripts, and phase reports are available in the Glossa-Lab repository at \url{https://github.com/tristanp/glossa-lab}. The Holdat LLC Indus Corpus v3 was accessed under private agreement for this study; public release is pending. Reproduction of corpus-level counts requires access to that corpus or a compatible public corpus such as ICIT after sign-code crosswalking.
...
\item
  ...
  [unpublished manuscript; cited with author permission; full bibliographic details to be confirmed before public submission]
\item
...
\item
  ...
  Preprint. [personal communication / manuscript in preparation; URL to be confirmed before public submission]
\item
...
HIGH anchors: supported within internal checks (Phase-46) - Sign coverage: 390 M-numbers all
