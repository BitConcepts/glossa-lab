...
LIBRARY: list[dict[str, Any]] = [
    ...
    # MoE (efficient — uses only 3B active params)
    {
        "name": "qwen3:30b-a3b",
        "display": "Qwen 3 30B-A3B (MoE)",
        "family": "qwen",
        "size_gb": 18.0,
        "min_vram_gb": 10,
        "param_b": 30,
        "desc": "Alibaba Qwen 3 MoE — 30B total but only 3B active. Best local model for its VRAM cost.",
        "quality": "excellent",
        "glossa_score": 10,
        "tags": ["moe", "reasoning", "multilingual", "top-pick", "recommended"],
    },
    {
        "name": "qwen3:8b",
        "display": "Qwen 3 8B",
        ...
        "min_vram_gb": 5,
        "param_b": 8,
        "desc": "Qwen 3 dense 8B. Strong multilingual + reasoning at small size.",
        "quality": "great",
        "glossa_score": 8,
    ...
    },
    {
        ...
        "min_vram_gb": 16,
        "param_b": 27,
        "desc": "Google Gemma 3 27B. Strong conversational ability and document understanding.",
        "quality": "excellent",
        "glossa_score": 9,
        "tags": ["conversational", "google"],
    },
    # Large (24+ GB VRAM)
    {
        "name": "llama3.3:70b",
        ...
        "min_vram_gb": 24,
        "param_b": 70,
        "desc": "Meta's latest 70B. Highest-scoring local model across all buckets.",
        "quality": "excellent",
        "glossa_score": 10,
        "tags": ["large", "research", "top-pick", "recommended"],
    },
    {
