...
\item
  Betweenness centrality stratification (Phases 172--177): deferred to
  a subsequent version of this preprint
\end{enumerate}
...
with documented ancient dock). The compound-only constraint is
site-invariant: it holds at coastal and inland sites equally, indicating
it is a scribal rule rather than a geographic pattern. This result is
...
% §3.32 Betweenness Centrality Stratification removed from this version.
% The analysis was contributed by A. Roif (Ben-Gurion University) whose
% methodological framework is under preparation for journal submission.
% This section will be reinstated upon publication of Roif (forthcoming).
...
I thank A. Roif (Ben-Gurion University of the Negev) for
correspondence on the Indus script.
