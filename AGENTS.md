...
This rule is tracked as governance-tool governance issue **SPEC-GL-001**: *"Python agent execution must use script files — python -c is forbidden for non-trivial commands."* Filed 2026-04-15.
