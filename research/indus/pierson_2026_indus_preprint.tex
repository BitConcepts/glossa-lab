...
DOI: \href{https://zenodo.org/records/20401711}{10.5281/zenodo.20401711}
...
7,002 tokens, 9 sites; Mahadevan M-numbers) and the ICIT corpus
...
isolated fish signs across all tested formal seal-object contexts. Tamil-Brahmi
...
tables, and phase reports are open source. DOI: 10.5281/zenodo.20401711.
...
approximately 5,000 inscribed objects --- seal objects (traditionally called ``stamp seals,'' though their actual function
remains debated; see Gokhale \& Ameri 2026), copper tablets,
potsherd graffiti, and the Dholavira signboard --- bearing a script of
approximately 400--700 distinct signs (depending on the catalogue). The analysis presented
here does not depend on whether these objects functioned as seals,
tags, amulets, or administrative tokens.
...
\textbf{Cross-validation corpus}: ICIT corpus (Yajnadevam 2024),
...
ICIT corpus; Elamite cognate confirmation (McAlpin 1981); DEDR
...
phoneme resolution; (c) Phases 253--280 integrated the ICIT corpus
...
both the Holdat corpus and the ICIT corpus, providing two
...
signs), plus 208 additional signs encountered in the ICIT corpus
...
\textbf{Grammar validation on the ICIT corpus}: The tripartite
...
The fish sign is \textbf{never} isolated in the formal inscribed
seal-object corpus. Convergent evidence from the Gulf seal tradition: Dilmun-style
...
\textbf{0/140} across all tested formal seal-object contexts.
...
\textbf{ICIT corpus SA}: 83.7\% mean consistency across 316
...
The ICIT SA provides independent validation: the ICIT corpus
...
\subsubsection{3.7 ICIT Cross-Corpus
Validation}\label{yajnadevam-cross-corpus-validation}

The ICIT corpus (Yajnadevam 2024) was integrated in Phases
281--294. Key results:

\begin{itemize}
\tightlist
\item
  \textbf{Crosswalk}: 316/707 ICIT signs mapped to Mahadevan
...
\item
  ...
  sites, generalizes to 67 additional ICIT sites without
  modification
\end{itemize}
...
a shared scribal tradition. On the 76-site ICIT corpus, site
...
modals lacking clear DEDR matches. The ICIT corpus, providing
...
\item
  \textbf{Crosswalk coverage}: The ICIT crosswalk covers 316/707
...
corpus. SA consistency of 83.7\% on the independent ICIT corpus.
...
requires access to that corpus under agreement. The ICIT corpus
...
cross-corpus ICIT SA validation, Elamite cognate confirmation,
...
316 ICIT cross-corpus confirmations, 7 Elamite cognate matches,
