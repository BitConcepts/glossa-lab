...
(permutation null \textit{z}\,=\,10.3; permutation \textit{p}\,=\,0/2000),
...
distinct bigrams, including 1,485 H+MxH+M bigrams. The dominant formula
...
(G-prefix ICIT coding) with an independent methodology, replicating the key structural result of our Phase-134 F1 test (\textit{z}=10.3, \textit{p}=0/2000) on an
...
(\textit{z}\,=\,10.3; permutation \textit{p}\,=\,0/2000), a recurring three-slot inscription formula,
