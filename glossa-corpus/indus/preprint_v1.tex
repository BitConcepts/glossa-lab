...
(permutation null $z=10.3$, $p < 0.001$),
...
\item
  ...
  M202=can SUPPORTED\_WITHIN\_MODEL; M198=co PROVISIONAL\_MEDIUM (all 4 have DEDR backing)
\item
...
\emph{Note: This test was run against the 157-sign H+M set (pre-Phase-163). The sibilant gap noted here was partially addressed by Phase-166, which added M198=\emph{co} as PROVISIONAL\_MEDIUM --- covering the /co/ slot but not /su/ or /shu/.}
...
signs promoted to PROVISIONAL\_MEDIUM status based on ≥3 independent text
...
\item
  Martini, G. (2025). \emph{Arthaśāstra Administrative Vocabulary and
  IVC Seal Inscription Typology}. PhD dissertation.
  [Author name to be confirmed with publisher before journal submission.]
\item
  McAlpin, D.W. (1981). \emph{Proto-Elamo-Dravidian: The Evidence and
  Its Implications}. Philadelphia: American Philosophical Society.
\item
  Miller, W. (2025). Holdat LLC Indus Corpus v3. Dataset. Held by author; public release timeline pending. Accessed via private agreement for this study.
\item
...
\item
  Roif, A. (2025a). The Indus Script as a Mnemonic Framework.
  Preprint. [URL/DOI to be confirmed with author before submission.]
\item
...
confirmed - Fish sign polysemy: 0/140 isolated (0/113 corpus + 0/27 Gulf; Phases 124/127/156)
