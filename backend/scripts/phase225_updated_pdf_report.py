...
def main():
    ...
    try:
        ...
        story.append(Paragraph(
            f"228 LOW anchors upgraded to MEDIUM via dual Elamite+Sanskrit phonotactic corroboration "
            f"(Phase-235+236) with DEDR injection. "
            f"<b>H+M total: 164 \u2192 {hm_after_239}</b> "
            f"({n_high} HIGH + <b>{medium_after_239} MEDIUM</b>). "
            f"Only <b>{low_after_239} LOW</b> anchors remain. "
            f"94.9% of all 413 anchors now have H+M confidence. "
        ...
        story.append(Paragraph(
            ...
            f"Phases 1–239 complete | H+M={hm_after_239}/413",
            small_style,
        ))
