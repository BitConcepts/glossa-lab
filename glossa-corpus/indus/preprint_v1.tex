...
\section{Computational Decipherment of the Indus Valley Script: 268
Anchors, 96.2\% Token Coverage, and a Proto-Dravidian Guild-Name
...
achieving 268 sign anchors at HIGH or MEDIUM confidence, 96.2\% token
coverage across 7,002 corpus tokens, and full decoding of 1,429/1,670
(85.6\%) seals. Working from the Holdat LLC corpus (1,670 seals, 9
...
validation (45/45 independent checks) confirms the Dravidian phonetic
...
\item
  A publish-read anchor table covering all 268 H+M signs with DEDR
  citations
\item
...
The 268 H+M anchors cover 6,733 of 7,002 corpus tokens. The remaining
269 tokens (3.8\%) have LOW-confidence readings only.
...
45 independent checks (foundation\_check.py) all pass, including: -
