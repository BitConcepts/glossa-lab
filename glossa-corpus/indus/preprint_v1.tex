...
(\textit{z}\,=\,10.3; permutation \textit{p}\,=\,0/2000),
...
context; bi$\rightarrow$vī bilabial shift \\
\end{longtable}
}
...
suggestion in Martini (2025, unpublished manuscript) that commodity tallies may have been recorded on
...
(G-prefix ICIT coding) with an independent methodology, replicating the key structural result of our Phase-134 F1 test (\textit{z}\,=\,10.3; permutation \textit{p}\,=\,0/2000) on an
...
alternative readings (e.g., ``ay/ā'' contains both front vowel "ay$\rightarrow$ai"
...
blockers were promoted to MEDIUM: 90.96\% $\rightarrow$ 92.35\%. Note: the full-corpus
...
(ship superintendent). This interpretation is consistent with later South Asian administrative vocabulary, but the proposed continuity remains speculative (Martini 2025, unpublished manuscript).
...
veL, comitative \\
M149 & or & MEDIUM & 987 & MEDIAL; {[}kōṉ{]}$\rightarrow$or$\rightarrow${[}an{]}; Dravidian
oru=one/a certain \\
