...
($z = 10.3$; permutation $p = 0/2000$), a recurring three-slot inscription formula,
...
computational tooling (Glossa-Lab pipeline, Warp/Oz agent). Analysis scripts, anchor tables, and phase reports are available in the Glossa-Lab repository. The Holdat LLC Indus Corpus v3 was accessed under private agreement and is not yet publicly released; full corpus-level replication requires access to that corpus or a compatible public corpus after sign-code crosswalking. Statistical tests were designed,
